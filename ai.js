...
const AI_SUBJECT_HINT = {
  math: 'математике (программа вступительного испытания АлтГТУ: алгебра, начала анализа, тригонометрия, геометрия, вероятность — уровень ЕГЭ)',
  inf: 'информатике (программа вступительного испытания АлтГТУ: системы счисления, логика, кодирование информации, алгоритмы, программирование, сети, комбинаторика — уровень ЕГЭ)',
  rus: 'русскому языку (программа вступительного испытания АлтГТУ: орфография, пунктуация, орфоэпия, лексические и грамматические нормы — уровень ЕГЭ)'
};
